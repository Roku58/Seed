...
- **[1] で草原へ出撃**: 緑の Plane 地面、青カプセル=プレイヤー（頭キューブ＋黒い鼻＋左腕の関節キューブ＋ポニーテール4関節）、灰色キューブ=敵。左上に HUD（Hunter / Monster の HP 行）。Hierarchy では「HomePhase」が消え「Stage_Grassland」が現れる
...
| [2] | Interact | 出撃: 火山（202・敵の攻撃間隔2.5秒） | - | - |
| [3] | Submit | ショップへ | - | - |
